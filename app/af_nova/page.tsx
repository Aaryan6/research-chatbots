...
export default async function AfNovaPage() {
  ...
  if (userInfo?.value) {
    try {
      ...
      if (dbUser) {
        validatedUserInfo = {
          ...dbUser,
          group: 3 // Automatically set group for af_nova
        };
      }
    } catch (error) {
  ...
  return (
    <main className="relative min-h-screen">
      ...
      <div className="container mx-auto ">
        <Hero />
        <Chat userInfo={validatedUserInfo} hideGroupSelect={true} predefinedGroup={3} />
      </div>
    </main>
  );
} 