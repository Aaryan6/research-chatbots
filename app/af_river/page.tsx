...
export default async function AfRiverPage() {
  ...
  if (userInfo?.value) {
    try {
      ...
      if (dbUser) {
        validatedUserInfo = {
          ...dbUser,
          group: 4 // Automatically set group for af_river
        };
      }
    } catch (error) {
  ...
  return (
    <main className="relative min-h-screen">
      ...
      <div className="container mx-auto ">
        <Hero />
        <Chat userInfo={validatedUserInfo} hideGroupSelect={true} predefinedGroup={4} />
      </div>
    </main>
  );
} 