...
export default async function AmAdamPage() {
  ...
  if (userInfo?.value) {
    try {
      ...
      if (dbUser) {
        validatedUserInfo = {
          ...dbUser,
          group: 7 // Automatically set group for am_adam
        };
      }
    } catch (error) {
  ...
  return (
    <main className="relative min-h-screen">
      ...
      <div className="container mx-auto ">
        <Hero />
        <Chat userInfo={validatedUserInfo} hideGroupSelect={true} predefinedGroup={7} />
      </div>
    </main>
  );
} 