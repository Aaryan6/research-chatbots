  ...
  return (
    <Card className="w-full h-full md:w-[400px] md:h-[600px] rounded-none overflow-hidden md:rounded-3xl border-0 shadow-2xl bg-white">
      <CardHeader className="border-b px-6 py-4 bg-gradient-to-r from-gray-900 to-gray-800">
        <h2 className="text-xl font-semibold text-white">How was your experience?</h2>
        <p className="text-gray-300 text-sm">Your feedback helps us improve</p>
      </CardHeader>
      <CardContent className="p-6 space-y-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-3">
            <label className="block text-lg font-medium text-gray-700">Rate your chat experience</label>
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 min-h-[120px] text-gray-700"
              placeholder="What did you like or dislike about the chat?"
              rows={4}
            />
          </div>
